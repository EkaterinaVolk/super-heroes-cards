...
window.addEventListener('load', addHero);
container.addEventListener('click', addRating);
...
function addHero() {
  ...
  heading.innerHTML = hero.name;
  paragraph.innerHTML = `universe: ${hero.universe}<br>alterego: ${hero.alterego}<br>occupation: ${hero.occupation}<br>friends: ${hero.friends}<br>superpowers: ${hero.superpowers}`;
